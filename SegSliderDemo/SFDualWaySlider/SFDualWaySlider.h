...
@interface SFDualWaySlider : UIView<UIGestureRecognizerDelegate>
...
@property (assign, nonatomic) CGFloat minRange;//当前可用范围最小值
@property (assign, nonatomic) CGFloat maxRange;//当前可用范围最大值
@property (strong, nonatomic) UIView *progressView;//滑杆灰色背景
@property (strong, nonatomic) UIView *lightView;//高亮选中View
...
/**
 点击滑杆背景
 */
@property (copy  , nonatomic) void(^clickProgressView)(CGFloat x);
